...
const buttonVariants = cva(
  "inline-flex hover:cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-themeButton text-themeButtonText shadow-xs hover:bg-themeButton-90",
        destructive:
        ...
        ghost: "hover:bg-themeButton hover:text-themeButtonText border border-themeText",
        link: "text-primary underline-offset-4 hover:underline",
        green: "bg-green1 text-white shadow-xs hover:bg-green1/80 font-semibold",
        orange: "bg-orange1 text-white shadow-xs hover:bg-orange1/80 font-semibold",
        teal: "bg-teal4 text-white shadow-xs hover:bg-teal4/80 font-semibold",
        teal1: "bg-teal1 text-white shadow-xs hover:bg-teal4/80 font-semibold"
      },
      size: {
